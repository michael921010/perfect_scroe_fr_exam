...
var PullToRefresh = function (_a) {
  var _b = _a.isPullable,
    ...
    refreshingContent =
      _d === void 0 ? React.createElement(RefreshingContent, null) : _d,
    _e = _a.pullingContent,
    pullingContent =
      _e === void 0 ? React.createElement(PullingContent, null) : _e,
  ...
  const parent = useMemo(() => _a.container ?? window, [_a.container]);
  ...
  useEffect(
    function () {
       ...
       */
      if (
        !((_a = containerRef) === null || _a === void 0 ? void 0 : _a.current)
      )
        return;
  ...
  var getScrollToBottomValue = function () {
    ...
    var scrollTop = _a.container ? _a.container.scrollTop : window.scrollY; // is the pixels hidden in top due to the scroll. With no scroll its value is 0.
    var scrollHeight = childrenRef.current.scrollHeight; // is the pixels of the whole container
    return (
      scrollHeight -
      scrollTop -
      (_a.container ? _a.container.clientHeight : window.innerHeight)
    );
  };
  ...
  var onTouchStart = function (e) {
    ...
    if (parent.TouchEvent && e instanceof TouchEvent) {
  ...
  var onTouchMove = function (e) {
    ...
    childrenRef.current.style.transform =
      "translate(0px, " + yDistanceMoved + "px)";
  ...
  var onEnd = function () {
    ...
    if (childrenRef.current) {
      childrenRef.current.style.overflow = "visible";
      childrenRef.current.style.transform =
        "translate(0px, " + pullDownThreshold + "px)";
    }
